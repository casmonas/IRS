  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Internal Request Form</h1>
    ...
    <section class="content">
     ...
     <!-- Form starts here -->
              <form role="form"  action="internalrequest.php" method="post">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="card-header">
                <h3 class="card-title" align="center">Make an Internal Request</h3>
              </div>
                <div class="card-body">
                    <div class="row">
                  <div class="col-sm-4">
                  ...
                  <div class="col-sm-4">
                      <!-- text input current_timestamp()  CURRENT_TIMESTAMP-->
                      <div class="form-group">
                        ...
                        <option value="">Select Request</option>
                          ...
                          <option value="Operational Demands">Operational Demands</option>
              ...
              if( isset($_POST['btnSave'])){
                ...
                //CURRENT_TIMESTAMP
                                ...
                                {                                       
                                    ...
                                    $requester = $_SESSION['utype'];

                                    $iSql = " INSERT INTO `internalrequestTable` (`requestID`, `requestType`,`requestReason`, `requestDepartment`,`authority`,`userID`,`requester`)  VALUES ('$requestID', '$requestType','$requestReason','$requestDepartment','$authority','$userID','$requester') ";
